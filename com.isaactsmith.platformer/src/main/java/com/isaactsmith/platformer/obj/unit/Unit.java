...
public abstract class Unit extends Obj {
	...
	private static final int FRAMES_PER_IMAGE_CHANGE = 90;
	...
	private double jumpSpeed = 8 * getScalar();
	private double currentJumpSpeed = jumpSpeed;
	private boolean isJumping = false;
	private double moveSpeed = 2.5 * getScalar();
	// Collision handlers
	...
	public Unit(int x, int y, BufferedImage[] images, double moveSpeed) {
		super(x, y, images);
		this.moveSpeed = moveSpeed * getScalar();
	}
